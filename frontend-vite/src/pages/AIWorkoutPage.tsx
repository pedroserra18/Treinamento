...
import { ChevronLeft, Clock, Sparkles, CheckCircle2, ChevronUp, ChevronDown, RefreshCw, AlertTriangle, X, ArrowRight } from 'lucide-react'
...
import {
  dayOfWeekLabels, focoFromDayLabel, rpeFromRir,
} from './ai/ai-review-metrics'
import {
  AITextRenderer, DetailStat, HeroStat, OptionCard, ProgressBar,
