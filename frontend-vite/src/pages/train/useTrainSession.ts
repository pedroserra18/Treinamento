...
import { formatSetPerformanceLabel } from './train-format'
import { resolveLastSetPerformance } from './set-display'
import type { TrainScreen, TrainOriginMode, TrackingType, ExerciseSetInput, ActiveExercise, LastUseInfo, RoutineFilter } from './types'
import { workoutSessionReducer, initialWorkoutSessionState } from './workout-session-reducer'
import { nextSupersetGroupId } from './superset'
import {
...
// ─── Estado + logica da tela de treino ─────────────────────────────────────
// Container hook: concentra TODO o estado, efeitos e handlers da TrainPage
// (dashboard/rotinas/sessao ativa/resumo/save). A pagina so consome este hook
// e roteia as telas. Extraido verbatim da TrainPage (comportamento preservado).
