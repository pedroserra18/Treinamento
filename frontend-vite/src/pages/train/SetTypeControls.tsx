...
import { SET_TYPE_GLYPH, type SetType } from '../../components/common/setTypeOptions'

// Badge clicável de tipo de série + bottom sheet de seleção. Componentes
// autocontidos (recebem tudo por props) — extraídos do TrainPage pra reduzir o
// arquivo, sem mudar comportamento. A tabela de glifos vem de setTypeOptions
// (fonte única, sem duplicar).
