...
import { TabSwitcher } from './progress/exercise-card'
import { ProgressExerciseTab } from './progress/ProgressExerciseTab'
import { ProgressBodyTab } from './progress/ProgressBodyTab'
    ...
    <section className="space-y-4">
      ...
      {tab === 'exercise' && (
        <ProgressExerciseTab
          ...
          muscleVolume30D={muscleVolume30D}
          ...
          openedPinnedExerciseId={openedPinnedExerciseId}
          setOpenedPinnedExerciseId={setOpenedPinnedExerciseId}
          draggingExerciseId={draggingExerciseId}
          setDraggingExerciseId={setDraggingExerciseId}
          dropTargetExerciseId={dropTargetExerciseId}
          setDropTargetExerciseId={setDropTargetExerciseId}
          handlePinExercise={handlePinExercise}
          handleUnpinExercise={handleUnpinExercise}
          handleReorderPinned={handleReorderPinned}
          setTab={setTab}
      ...
      {tab === 'body' && (
        <ProgressBodyTab
          ...
          loading={loading}
          measurementsOldFirst={measurementsOldFirst}
          measurementsNewFirst={measurementsNewFirst}
          latestMeasurement={latestMeasurement}
          showAddForm={showAddForm}
          setShowAddForm={setShowAddForm}
          showMoreMeasures={showMoreMeasures}
          setShowMoreMeasures={setShowMoreMeasures}
          form={form}
          setForm={setForm}
          measurementPhotoPreview={measurementPhotoPreview}
          measurementPhotoFile={measurementPhotoFile}
          savingMeasurement={savingMeasurement}
          ...
          handleMeasurementPhotoFile={handleMeasurementPhotoFile}
