...
// ─── Estado + logica do gerador de treino IA ────────────────────────────────
// Container hook: concentra todo o estado, efeitos e handlers das telas
// (WELCOME/LOADING/QUIZ/REVIEW/RESULT). A pagina (AIWorkoutPage) so consome
// este hook e roteia as telas. Extraido verbatim da AIWorkoutPage.
