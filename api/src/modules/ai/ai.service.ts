...
import { assertWithinLimitForUser } from "../../shared/plan-limits";
import { GenerateWorkoutBody } from "./ai.schema";
...
// Persistencia/historico de treinos gerados por IA vivem em
// ai-history.service.ts. Reexportado aqui para o controller nao mudar imports.
